...
# CCCCCCCCC
ra_gal_ran = ra_ran[:7*len(ra_gal_bin)]
dec_gal_ran = dec_ran[:7*len(ra_gal_bin)] 

RADEC_ran = np.zeros((len(ra_gal_ran),2))
RADEC_ran[:,0] = ra_gal_ran
RADEC_ran[:,1] = dec_gal_ran
...
# Get patch centers while conserving memory by using every_nth switch
partial_cat = treecorr.Catalog(ra=ra_gal_bin, dec=dec_gal_bin, ra_units='degrees', dec_units='degrees', npatch=N_jk, every_nth=100)
patch_centers = partial_cat.patch_centers
del partial_cat  # Don't need it anymore

# Instantiate full catalogs
gal_cat = treecorr.Catalog(ra=ra_gal_bin, dec=dec_gal_bin, ra_units='degrees', dec_units='degrees', patch_centers=patch_centers, save_patch_dir=outfile)
gal_ran_cat = treecorr.Catalog(ra=ra_gal_ran, dec=dec_gal_ran, ra_units='degrees', dec_units='degrees', patch_centers=patch_centers, save_patch_dir=outfile)
cen_cat = treecorr.Catalog(ra=ra_cen_bin, dec=dec_cen_bin, ra_units='degrees', dec_units='degrees', patch_centers=patch_centers, save_patch_dir=outfile)
ran_cat = treecorr.Catalog(ra=RA_ran, dec=DEC_ran, ra_units='degrees', dec_units='degrees', patch_centers=patch_centers, save_patch_dir=outfile)
