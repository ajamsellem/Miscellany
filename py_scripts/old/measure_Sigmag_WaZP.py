...
outfile = sys.argv[14]
nR = int(sys.argv[15])                      # Number of R bins
i = int(sys.argv[16])
...
mask_ran = (Z_ran>=0.)                      # This is different from the measure_sigmag for RM b/c WaZP randoms don't have redshift
...
#np.savez('./Sigmag_WaZP_results/debug.npz', dd=dd.xi, dd_w=dd.weight, rd=rd.xi, rd_w=rd.weight, dr=dr.xi, dr_w=dr.weight, rr=rr.xi, rr_w=rr.weight)
#dd.write('./Sigmag_WaZP_results/debug.npz',rr,dr,rd)
