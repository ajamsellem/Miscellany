...
RA[RA>180] -= 360.      # Why is this transformation necessary?
...
pixsjk = np.append(pixsjk,pixjk)   # This gives where cluster galaxies could be
...
for i in range(Nz):
    ...
    n_clust_ran = len(ra_ran_bin) # Won't Work....
    n_clust_ran_w = len(ra_ran_bin)
